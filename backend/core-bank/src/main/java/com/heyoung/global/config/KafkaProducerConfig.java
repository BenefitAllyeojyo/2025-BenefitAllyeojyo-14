...
/**
 * Outbox → Kafka 승격의 프로듀서 설정.
 * jasypt 로 암호화된 application.yml 대신 부트스트랩 주소만 @Value 로 명시 주입(기본 localhost:9092)한다.
 * acks=all + enable.idempotence=true 로 프로듀서 레벨에서 유실/중복을 1차 방어한다.
 */
@Configuration
